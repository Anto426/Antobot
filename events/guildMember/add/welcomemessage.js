...
module.exports = {
    ...
    async execute(member) {
        if (!member.user.bot) {
            ...
            let channel = configs.client.channels.cache.get(configs.settings[member.guild.name].stanze.welcome)

            let attachment = new configs.Discord.AttachmentBuilder(canvas.toBuffer(), { name: "canvas.png" })
